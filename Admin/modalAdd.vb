...
Public Class modalAdd
    ...
    Public Sub AddAdminAccount()
        Try
            ...
            Dim query As String = "INSERT INTO AdminAccount (FirstName, LastName, MiddleName, Gender, ContactNumber, DateAdded, Username, Password, Email) " &
                                  "VALUES (@FirstName, @LastName, @MiddleName, @Gender, @ContactNum, GETDATE(), @Username, @Password, @Email)"

            If Connection.Insert(query) Then
                MsgBox("Admin added successfully!", MsgBoxStyle.Information)
                ClearFields()
                Me.DialogResult = DialogResult.OK
                Me.Close()
            Else
                MsgBox("Failed to add admin account.", MsgBoxStyle.Exclamation)
            End If
    ...
    Private Sub modalAdd_Load(sender As Object, e As EventArgs) Handles Me.Load
