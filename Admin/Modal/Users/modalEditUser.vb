...
Public Class modalEditUser

    Public userID As Integer

    Private Sub LoadUserID(id As Integer)
        Connection.AddParam("@userID", id.ToString())
        Connection.Query("SELECT * FROM UserAccount WHERE UserAccountID = @userID")
    ...
    Public Sub ClearFields()
        ...
        txtEmail.Clear()
    End Sub
    Public Sub UpdateUserAccount(userID As Integer)
        Try
            ...
            If Connection.Update(query) Then
                ...
                Me.Close()
            Else
                MsgBox("Failed to update user account.", MsgBoxStyle.Exclamation)
            End If
    ...
    Private Sub modalEditUser_Load(sender As Object, e As EventArgs) Handles MyBase.Load
